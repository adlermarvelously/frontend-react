...
// alert(`${sayiBaslangic} ile ${sayiBitis} kadar olan sayıların toplamı = ${toplam}`)
...
//     let not = Number(prompt("Ögrenci " + ogrenci + " notunu girin:"))
//     toplamNot += not
...
//     }
// }
// let sinifOrtalaması = toplamNot / ogrenciSayisi
// console.log("Sınıf ortalaması: " + sinifOrtalaması);
