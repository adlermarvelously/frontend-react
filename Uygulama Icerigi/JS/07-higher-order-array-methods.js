...
const buyukHarfler = dizi1.map((eleman) => eleman.toLocaleUpperCase("TR"));
...
const uzunluk = 4
const kısaStringler = dizi1.filter(eleman => eleman.length === uzunluk)
console.log(kısaStringler);
...
const ilkCiftSayı = dizi.find(eleman => eleman % 2 === 0)
console.log(ilkCiftSayı);
